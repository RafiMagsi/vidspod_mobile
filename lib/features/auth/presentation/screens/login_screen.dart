          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: CreatiTheme.bodyMedium(color: Colors.white.withAlpha(120)),
              ),
              const SizedBox(height: 48),
              Container(
                decoration: BoxDecoration(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Email',
                    hintStyle: CreatiTheme.bodyMedium(color: Colors.white.withAlpha(60)),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Password',
                    hintStyle: CreatiTheme.bodyMedium(color: Colors.white.withAlpha(60)),
                    prefixIcon: Icon(Icons.lock_outline, color: Colors.white.withAlpha(80), size: 20),
                ...
                child: Container(
                  ...
                  child: Center(
                    child: authState == AuthStatus.loading
                        ...
                        : Text('Sign In', style: CreatiTheme.bodyMedium(fontWeight: FontWeight.w600, fontSize: 16)),
                  ),
                ),
              ),
              ...
              Center(
                child: TextButton(
                  onPressed: () {},
                  child: Text('Forgot Password?', style: CreatiTheme.bodySmall(color: Colors.white.withAlpha(100))),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  Text("Don't have an account?", style: CreatiTheme.bodySmall(color: Colors.white.withAlpha(100))),
                  const SizedBox(width: 4),
                  TextButton(
                    onPressed: () {},
                    child: Text('Sign Up', style: CreatiTheme.bodySmall(fontWeight: FontWeight.w600, color: CreatiTheme.purple)),
                  ),
                ],
              ),
            ],
