...
class ToolsScreen extends StatelessWidget {
  ...
  static const List<_ToolItem> _tools = [
    _ToolItem('Image Studio', 'Create and edit AI images', Icons.image_outlined, '/image-studio'),
    _ToolItem('Voice Studio', 'Generate AI voiceovers', Icons.record_voice_over_outlined, '/voice-studio'),
    _ToolItem('Research Tools', 'Market & trend research', Icons.science_outlined, '/research'),
    _ToolItem('Script Writer', 'AI-powered script generation', Icons.article_outlined, '/script-writer'),
    _ToolItem('YouTube Download', 'Download videos & audio', Icons.download_outlined, '/youtube-download'),
  ];
