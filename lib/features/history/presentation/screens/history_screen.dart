        ...
        child: Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Available Credits', style: CreatiTheme.bodyMedium(fontWeight: FontWeight.w500)),
              const SizedBox(height: 2),
              Text('4 credits remaining', style: CreatiTheme.bodySmall(color: Colors.white.withAlpha(100))),
            ]),
          ),
          Container(
            ...
            child: Text('Buy', style: CreatiTheme.bodySmall(fontWeight: FontWeight.w600)),
          ),
        ]),
      ),
    );
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(children: [
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Become an ambassador', style: CreatiTheme.bodyMedium(fontWeight: FontWeight.w600, fontSize: 15)),
              const SizedBox(height: 3),
              Text('Earn rewards by referring friends', style: CreatiTheme.bodySmall(color: Colors.white.withAlpha(110))),
            ]),
          ),
          Container(
            ...
            child: Text('Join', style: CreatiTheme.bodySmall(fontWeight: FontWeight.w600)),
          ),
        ]),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TabBar(
        ...
        labelStyle: CreatiTheme.bodySmall(fontWeight: FontWeight.w600),
        unselectedLabelStyle: CreatiTheme.bodySmall(),
                ...
                children: [
                  CachedNetworkImage(
                    ...
                    errorWidget: (_, __, ___) =>
                        AppPlaceholder(icon: i % 2 == 0 ? Icons.image_outlined : Icons.videocam_outlined),
                  ),
                  Positioned(
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        i % 2 == 0 ? Icons.image_outlined : Icons.videocam_outlined,
