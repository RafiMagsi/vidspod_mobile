  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        Text('Good photo examples', style: CreatiTheme.headingSmall(fontSize: 16)),
      ]),
      const SizedBox(height: 14),
      SizedBox(
        height: 200,
        child: ListView(scrollDirection: Axis.horizontal, children: [
          _GoodCard('Single product', 'Clean background', 'https://picsum.photos/seed/g1/200/300'),
          const SizedBox(width: 12),
          _GoodCard('Full product shot', 'Well lit scene', 'https://picsum.photos/seed/g2/200/300'),
        ]),
      ),
    ]);
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(fit: StackFit.expand, children: [
        ...
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(colors: [Colors.transparent, Colors.black.withAlpha(200)], begin: Alignment.topCenter, end: Alignment.bottomCenter),
          ),
          padding: const EdgeInsets.all(12),
          alignment: Alignment.bottomLeft,
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(title, style: CreatiTheme.bodySmall(fontWeight: FontWeight.w600)),
            const SizedBox(height: 2),
            Text(subtitle, style: CreatiTheme.caption(color: Colors.white70)),
          ]),
        ),
      ]),
    );
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        const SizedBox(width: 10),
        Text('Bad photo examples', style: CreatiTheme.headingSmall(fontSize: 16)),
      ]),
      const SizedBox(height: 14),
      SizedBox(
        height: 150,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(label, style: CreatiTheme.bodyMedium(color: Colors.white.withAlpha(100))),
      ]),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      GestureDetector(
        ...
        child: Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(Icons.camera_alt_outlined, color: Colors.white.withAlpha(230), size: 20),
            const SizedBox(width: 8),
            Text('From Camera', style: CreatiTheme.bodyMedium(fontWeight: FontWeight.w600, fontSize: 16)),
          ]),
        ),
      ),
      ...
      OutlinedButton(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.photo_library_outlined, color: Colors.white.withAlpha(150), size: 20),
          const SizedBox(width: 8),
          Text('From Photo', style: CreatiTheme.bodyMedium(fontWeight: FontWeight.w500, color: Colors.white.withAlpha(150), fontSize: 16)),
        ]),
      ),
    ]);
  }
